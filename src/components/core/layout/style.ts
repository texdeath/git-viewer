...
export const GlobalStyle = createGlobalStyle`
  @font-face{
    ...
    src: url(${require('@assets/fonts/Montserrat/Montserrat-Regular.woff2')}) format("woff2"),
    url(${require('@assets/fonts/Montserrat/Montserrat-Regular.woff')}) format("woff"),
    url(${require('@assets/fonts/Montserrat/Montserrat-Regular.svg')}#Montserrat-Regular) format("svg");
    font-style: 'normal';
    font-weight: 'normal';
  }
